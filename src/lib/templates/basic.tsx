...
export const BasicTemplate: React.FC<{ data: ResumeData }> = ({ data }) => {
    ...
    return (
        <div className="bg-white text-slate-800 w-full shadow-none print:shadow-none flex flex-col text-[9.5pt] font-mono">
            {/* Header - Simple */}
            ...
            <div className="px-10 py-3 gap-8">
                <main className="w-full">
                    <div className="space-y-3">
                        ...
                        {data.projects && data.projects.length > 0 && (
                            <section>
                                <h2 className={`text-xs uppercase tracking-widest mb-3 font-black ${c.primary}`}>Projects</h2>
                                <div className="space-y-3">
