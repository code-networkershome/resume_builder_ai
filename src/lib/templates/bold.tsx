...
export const BoldTemplate: React.FC<{ data: ResumeData }> = ({ data }) => {
    return (
        <div className="bg-white text-slate-800 w-full flex flex-col shadow-none print:shadow-none font-sans text-[10pt] leading-[1.4] flex-1">
            ...
            <header className="bg-slate-900 text-white px-[15mm] py-6 mb-4">
                <h1 className="text-3xl font-black uppercase tracking-tight leading-none mb-4">{data.header.name}</h1>
                <div className="flex flex-wrap gap-x-6 gap-y-1.5 text-[9pt] font-medium text-slate-300">
                ...
                <div className="flex flex-wrap gap-x-5 gap-y-1 text-[8.5pt] font-bold uppercase tracking-[0.15em] mt-3.5 border-t border-slate-800 pt-3">
            ...
            <div className="px-[15mm] space-y-6 flex-1 pb-10">
                {/* 1. Professional Experience */}
                {data.experience.length > 0 && (
                    <section>
                        <h2 className="text-[10pt] font-black uppercase tracking-[0.25em] text-slate-900 border-b-2 border-slate-900 pb-1 mb-4 flex items-center gap-4">
                        ...
                        <div className="space-y-5">
                            {data.experience.map((exp, i) => (
                                <div key={i}>
                                    ...
                                    <p className="text-slate-500 font-bold uppercase text-[9pt] tracking-widest mb-2">{exp.organization}</p>
                        ...
                        <div className="space-y-4">
                            {data.projects.map((proj, i) => (
                                <div key={i}>
                                    ...
                                    <p className="text-slate-500 font-medium italic text-[9.5pt] mb-2">{proj.techStack}</p>
                                    <ul className="space-y-1 text-[10pt] text-slate-600 font-medium leading-tight list-outside ml-4 list-disc">
