    ...
    return (
        <div className="bg-white text-slate-800 font-serif leading-snug w-full flex flex-col gap-3 shadow-none print:shadow-none text-[10pt] flex-1 px-12 py-10" style={{ fontFamily: "Times New Roman, serif" }}>
            ...
            <header className="text-center mb-2 border-b-2 border-slate-900 pt-1 pb-3">
                ...
                <div className="mt-1 text-[9pt] flex flex-wrap justify-center gap-x-4 gap-y-0.5 font-medium text-slate-800">
            ...
            <div className="space-y-3 flex-1">
                ...
                {data.experience.length > 0 && (
                    <section>
                        <h2 className="text-[11pt] font-bold uppercase border-b border-slate-300 mb-2 pb-0.5 tracking-wide">Experience</h2>
                        <div className="space-y-3">
                            {data.experience.map((exp, i) => (
                                <div key={i}>
                                    ...
                                    <p className="italic text-[10pt] text-slate-800 mb-0.5">{exp.role}</p>
                ...
                {data.projects.length > 0 && (
                    <section>
                        <h2 className="text-[11pt] font-bold uppercase border-b border-slate-300 mb-2 pb-0.5 tracking-wide">Projects</h2>
                        <div className="space-y-3">
                            {data.projects.map((proj, i) => (
                                <div key={i}>
                                    ...
                                    <p className="italic text-[9.5pt] text-slate-600 mb-0.5">{proj.techStack}</p>
                                    <ul className="list-disc list-outside ml-5 space-y-0.5 text-[10pt] text-slate-800">
                ...
                {data.skills.categories && data.skills.categories.some(cat => cat.skills) && (
                    <section>
                        <h2 className="text-[11pt] font-bold uppercase border-b border-slate-300 mb-2 pb-0.5 tracking-wide">Skills</h2>
                        <div className="space-y-0.5 text-[10pt] text-slate-800">
                ...
                {data.achievements.length > 0 && (
                    <section>
                        <h2 className="text-[11pt] font-bold uppercase border-b border-slate-300 mb-2 pb-0.5 tracking-wide">Achievements</h2>
                        <ul className="list-disc list-outside ml-5 space-y-0.5 text-[10pt] text-slate-800">
                ...
                {data.certifications.length > 0 && (
                    <section>
                        <h2 className="text-[11pt] font-bold uppercase border-b border-slate-300 mb-2 pb-0.5 tracking-wide">Certifications</h2>
                        <ul className="list-disc list-outside ml-5 space-y-0.5 text-[10pt] text-slate-800">
